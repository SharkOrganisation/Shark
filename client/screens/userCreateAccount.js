    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#9AC61C' }}>
            ...
            <View style={styles.inputContainer}>
                ...
                <View>
                    <Text placeholder='ENTER YOUR DATE OF BIRTH' style={{ color: "black", fontWeight: 'bold' }}>Date Of Birth</Text>
                    <TextInput style={styles.Input} />
                </View>
                <View style={styles.smallInptContainer}>
                    <View>
                        <Text style={{ color: "black", fontWeight: 'bold' }} >Height</Text>
                        <TextInput style={styles.smallInput} keyboardType="numeric" />
                    </View>
                    <View>
                        <Text style={{ color: "black", fontWeight: 'bold' }}>Weight</Text>
                        <TextInput style={styles.smallInput} keyboardType="numeric" />
                    </View>
                    <View>
